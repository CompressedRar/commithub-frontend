...
function HeadDepartment(){
    ...
    return(
        ...
        <div className="department-container" style={{gridTemplateColumns:"1fr"}}>
            ...
            {currentDepartment && <HeadDepartmentInfo key = {currentDepartment} id = {currentDepartment} loadDepts = {()=>{loadAllDepartments()}} firstLoad = {()=>{loadFirstDepartment()}}></HeadDepartmentInfo>}
        </div>
    )
}
