    ...
    >
      <div className="mb-4">
        ...
        <p className="text-muted small">
          This will create a new Profile and User account linked together
        </p>
        <hr />
      </div>
      ...
      <div className="mb-4 p-3 bg-light rounded">
        ...
        <div className="mb-3 text-center">
          ...
          <input
            ...
            hidden
          />
          <p className="small text-muted mt-2">Profile picture (optional)</p>
        </div>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            required
          />
          <div className="mt-1 small">{emailQueryResult}</div>
          <small className="text-muted">
            This email will be used to log in and receive account notifications
          </small>
        </div>
      </div>
      ...
      <div className="mb-4 p-3 bg-info bg-opacity-10 rounded border border-info">
        ...
        <ul className="small mb-0 text-dark">
          <li>
            <strong>Profile</strong> will be created with: Email address, profile
            picture, and auto-generated default password
          </li>
          <li>
            <strong>User Account</strong> will be linked to this profile with:
            Name, position, office assignment, and role
          </li>
          <li>
            Default password will be sent to the email address provided
          </li>
          <li>
      ...
      {/* Submit */}
      <div className="mt-auto pt-3 border-top text-end d-flex flex-row-reverse gap-2">
        <button
          type="submit"
